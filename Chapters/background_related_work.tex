...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\linewidth]{figures/ch2_activeLearning.png}
	\caption{Active vs Passive Learning}
	\cite[Rubens, 2011]{ rubens2011active}
	\label{fig:ch2_activeLearning}
\end{figure}
