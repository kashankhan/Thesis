...
\subsection{Mobile System}
 \cite{schiller2003mobile}
\begin{enumerate}

	\item \textbf{Device portability} \cite{nielsen1990heuristic}. 
	
	\item \textbf{User mobility} \cite{nielsen1990heuristic}.
	
	\item \textbf{Wireless connectivity} \cite{nielsen1990heuristic}.
...
\begin{enumerate}
	...
	\item \textbf{Resource limitation}\cite{ricci2010mobile}. 
	
	\item \textbf{Connectivity}\cite{ricci2010mobile}.
	
	\item \textbf{Battery life} \cite{ricci2010mobile}.
